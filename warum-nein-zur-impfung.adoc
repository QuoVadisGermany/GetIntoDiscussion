...
Über Monate klärte sich langsam auf, wie dieses Ergebnis zustande kam. Hierzu stehen einige Behauptungen im Raum.

* Ungeimpfte Intensivpatienten mit einem anderen Einweisungsgrund werden getestet und bei positivem Ergebnis als COVID-Patienten gezählt. Geimpfte Intensivpatienten werden nicht getestet (bestätigt, aufgedeckt von einem https://www.youtube.com/watch?v=LLpC7DOUH5w&t=39s[Youtuber])
...
* Patienten mit einer Impfung werden als ungeimpft gezählt.

* Patienten bei denen die Zweit-Impfung weniger als 14 Tage zurückliegt werden als ungeimpft gezählt.
...
*Ich bin kein Journalist und kann nicht jeder dieser Behauptungen nachrecherchieren.* Aber es läge an den Verantwortlichen, hier nachvollziehbar Aufklärung über die Zählweise zu geben. Der Journalist Boris Reitschuster hat über Monate versucht, diese Widersprüche in der Berechnung aufzuklären. Stellvertretend für viele Stunden Bundespressekonferenz, die ich zu dem Thema gesehen habe, sei dieses kurze https://www.youtube.com/watch?v=YoycxmZ3ji0[Video] genannt.
...
Diese Aussagen stehen auch im Widerspruch zu zahlreichen Faktencheckern (https://www.tagesschau.de/faktenfinder/ungeimpfte-covid-patienten-101.html[ARD] oder https://correctiv.org/faktencheck/2021/11/03/nein-geimpfte-zaehlen-nicht-als-ungeimpfte-sobald-sie-symptome-entwickeln/[Correctiv]), welche die Argumentation mit der Zählweise als Desinformation von "Querdenkern" einwerten.

Ich wünsche mir hier die Bereitstellung von transparenten, vollständigen und einsehbaren Zahlen deutschlandweit

* Werden alle Personen, die in deutschen Kliniken aufgenommen werden unabhängig vom Impfstatus getestet? (Angesichts der Tatsache, dass ich einen Test brauche um Bus zu fahren will ich das schwer hoffen)

* Pro Datensatz: Alterskohorte, Impfstatus, Symptome, Intensiv- oder Normlalpatient

Ich möchte da vollen Zugriff auf die gesamtdaten haben, damit man Korrelationen untersuchen kann.
