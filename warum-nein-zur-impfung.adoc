...
Von Beginn der Pandemie an ist die offenkundige notwendige Güterabwägung zwischen Nutzen und Schaden von Maßnahmen nie öffentlich diskutiert worden. Der Pandemiebekämpfung unter dem Motto "Es sterben Menschen" zunächst Vorrang einzuräumen, ist vielleicht in der Situation akuter Gefahr nachvollziehbar - aber sichtlich wird der Ausnahmezustand zur Dauereinrichtung - anstelle einer Normalisierung kommt man zu immer einschleindenderen Maßnahmen (Impfzwang) - hingegen hat die Politik es in 2 Jahren nicht geschafft, der Öffentlichkeit wenigstens Transparenz über Zahlen und Fakten zu liefern.
