...
=== Bedroht Populismus die Demokratie, oder treibt uns Repression in die Diktatur?

Im persönlichen Gespräch argumentierte ein Bekannter, dass Querdenker vor einer Diktatur warnen weise ihre Radikalisierung nach. Dies halte ich nicht für gerechtfertigt.

In meiner Schulzeit wurde aufgrund der Erfahrung des 3. Reichs argumentiert, die Deutschen sei nicht reif eine direkte Demokratie (z.B. Volksabstimmungen auf Bundesebene wie in der Schweiz). Diese Vorstellung eines Volkes, as
...
*Populismus und Internet*

Die hier geschilderte Steuerung der öffentlichen Meinung durch eine mächtige Elite in Medien und Politik ist auch deshalb keine Verschwörungstheorie, weil sie dem Selbstverständnis der alten Bundesrepublik entspricht. Ich habe in der Schule gelernt, dass man Volksabstimmungen auf Bundesebene aus der Erfahrung des 3. Reiches ablehnt - es gibt also in der Tat ein großes Misstrauen gegenüber dem Volk und die Vorstellung, dass man es anleiten müsse.
