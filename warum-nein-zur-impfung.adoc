...
In meiner Schulzeit wurde aufgrund der Erfahrung des 3. Reichs argumentiert, Deutschland eigne sich nicht für eine direkte Demokratie, wie sie z.B. in der Schweiz
