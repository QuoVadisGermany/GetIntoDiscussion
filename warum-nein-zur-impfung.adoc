...
Eine argumentative Debatte wird mit pauschalen Argumenten verweigert (unwissenschaftlich, demokratiefeindlich oder gleich https://www.youtube.com/watch?v=kArDFWTH2wE[menschenfeindlich]), an dessen Stelle tritt die Diffamierung, moralische Abwertung, schließlich die Verbannung aus dem Diskurs durch Zensur. Staatlicherseits vorzugeben, welche Meinungsäußerung als "falsch" delegitmiert wird erinnert an das "Ministerium für Wahrheit" in George Orwells "1984" und sollte in einer Demokratie nichts verloren haben.
