...
Eine rethorische Figur zum Diskussions-Abbruch mit der ich konfrontiert bin, ist das "getriggert" seien. Manche Zeitgenossen ertragen meine Meinung nicht. Nun kann ich sogar nachvollziehen, dass es für einen Betroffenen schwer seien kann, wenn seine Beschwerden verharmlost werden, daher:
