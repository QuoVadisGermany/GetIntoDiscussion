...
== Wir müssen uns der Denkverbote, die ausgerufen werden, erwehren und einander wieder zuhören
...
=== Politik und Medien setzen gezielte Strategien zur Vergiftung des Diskurses ein
