...
Bei der Grippe betragen die Schätzzahlen in der Tat das Vielfache der Testzahlen - diese Argumentation ist jedoch wenig stichhaltig, weil in 2021/22 eine praktisch 100%ige Corona-Testabdeckung bei Personen angenommen werden kann, die im Krankenhaus verstarben.
...
==== Argument: Behandlungsmethoden und Prävention
...
==== Argument: Aber die regionalen Hot-Spots zeigen doch die Gefährlichkeit
...
==== Argument: Aber Long Covid zeigt doch, wie gefährlich die Krankheit ist.
...
==== Argument: Schützt die Impfung den Impfling vor schwerer Erkrankung bzw. Tod?
...
==== Argument: Dr Sucharit Bhakdi und die Patologen
